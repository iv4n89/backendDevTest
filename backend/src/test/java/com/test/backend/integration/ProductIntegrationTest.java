...
public class ProductIntegrationTest {
        ...
        @Test
        @Order(2)
        @DisplayName("Case 2: Product without similar ids - should return 404")
        ...
        @Test
        @Order(4)
        @DisplayName("Case 4: Non-existent product - should return 404")
        ...
        @Test
        @Order(5)
        @DisplayName("Case 5: External service failure - should return 503")
        void shouldReturnEmptyListWhenExternalServiceFails() {
                // Mock similarids endpoint returning 500
                stubFor(get(urlEqualTo("/product/503/similarids"))
                                .willReturn(aResponse()
                                                .withStatus(503)));
